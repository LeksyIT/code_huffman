...
public class Main {
    ...
    public static void fileCompressTest(String fileName) {
        try {

            // загрузка содержимого файла в виде строки
            String content = new String(Files.readAllBytes(Paths.get("D:\\code_huffman\\src\\main\\java\\huffman\\text\\"+ fileName + ".txt")));
            ...
            File file = new File("D:\\code_huffman\\src\\main\\java\\huffman\\textHuf\\"+ fileName + ".huf");
            ...
            Files.write(Paths.get("D:\\code_huffman\\src\\main\\java\\huffman\\decompressedText\\"+ fileName + ".txt"), decoded.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
